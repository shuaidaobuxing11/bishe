...
## 7. 策略专项说明
解释来源：行为/轨迹统计（Captum 不可用或未使用）。 PPO baseline 通过在线交互学习；若 target_relative 与 inter_uav_coordination 较高且回报较高，说明其有效利用了相对目标关系与双机协同。

## 8. 自动总结
总体来看，**ppo_baseline** 在 **default** 场景下成功完成追踪。 episode return=-33.38，目标相对关系=0.81，双机协同=0.34，安全=0.39，场景匹配=0.66。