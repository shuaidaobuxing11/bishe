...
- **是否成功**: 是
- **episode length**: 115
- **episode return**: -73.11
- **是否碰撞**: 否
- **最小 UAV 间距**: 0.664
- **平均目标距离**: 3.266
- **最小目标距离**: 0.654
- **action switch rate**: 0.772
...
- **UAV 绝对位置** (`uav_absolute_score`): 0.027
- **UAV-目标相对关系** (`target_relative_score`): 0.707
- **双机协同** (`inter_uav_coordination_score`): 0.309
- **安全约束** (`safety_score`): 0.288
- **运动趋势/速度** (`velocity_score`): 0.000
- **动作稳定性** (`action_stability_score`): 0.228
- **任务效率** (`task_efficiency_score`): 0.606
- **场景匹配度** (`scenario_alignment_score`): 0.234

### Captum/轨迹组级归一化贡献
- **target_relative**: 65.0%
- **inter_uav_coordination**: 26.6%
- **uav_absolute**: 7.8%
- **target_absolute**: 0.4%
- **velocity**: 0.1%
...
## 8. 自动总结
总体来看，**expert_v2** 在 **near_uavs** 场景下成功完成追踪。 episode return=-73.11，目标相对关系=0.71，双机协同=0.31，安全=0.29，场景匹配=0.23。